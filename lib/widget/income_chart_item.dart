...
class IncomeChartItem extends StatefulWidget {
  const IncomeChartItem({super.key});

  @override
  State<IncomeChartItem> createState() => _IncomeChartItemState();
}

class _IncomeChartItemState extends State<IncomeChartItem> {
